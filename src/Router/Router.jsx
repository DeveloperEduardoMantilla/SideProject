...
export default function Router() {
  const { stateRoutes, setStateRoutes } = usePrivatizacion();
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route
            element={
              <ProtectedRoute
                canActivate={stateRoutes.Camper}
